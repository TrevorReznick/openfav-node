...
export class RedisController {
    static home = async (req: Request, res: Response) => {
        try {
            await redisConnect()
            await setRedisValue('mario', 'rossi')
    ...
    static getAccessToken = async (req: Request, res: Response) => {
        ...
        try {
            ...
            res.send(typeof accessTokenData === 'string' ? JSON.parse(accessTokenData) : accessTokenData)
        } catch (error) {
    ...
    static getRefreshToken = async (req: Request, res: Response) => {
        ...
        try {
            ...
            res.send(typeof refreshTokenData === 'string' ? JSON.parse(refreshTokenData) : refreshTokenData)
        } catch (error) {
